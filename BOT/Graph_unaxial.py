...
class UnaxialGraph(Graph_traxial):
    def __init__(self, dct: dict):
        self.global_schema = 'unaxial'
        ...
        self.plot = figure(width=1000, height=1000, x_range=(0, self.limit_axe_Y))
        ...
        self.glyph = self.plot.circle('y', 'x', size=10, color='blue', alpha=0.5, source=self.mid_line_values)
        ...
        # Отображение точек
        self.plot.line(x='y', y='x', line_color='green', line_width=1, source=self.mid_line_interpolate_values,
                       legend_label='Mid values')
        self.plot.line(x='y', y='x', line_color='blue', line_width=1, source=self.min_line_interpolate_values,
                       legend_label='Min value')
        self.plot.line(x='y', y='x', line_color='red', line_width=1, source=self.max_line_interpolate_values,
...
graphs = UnaxialGraph(distribut.data)
graphs.run()
"""
