...
def start_TPDS_RZG(dct: dict, name: str, methodINTERPOLATION):
    ...
    pressEnd1 = (otnForE50 - otn_pStart) * E_50 + pressStart1  # press END
    ...
    if pressE50 <= press16 + 0.005:
        pressE50 = press16 + random.randint(5, 15) / 1000
        pressEnd1 = pressE50 - press16 + pressE50
        otn_E50 = (((pressEnd1 + pressStart1) / 2) - pressStart1 + E_50 * otn_pStart) / E_50
        # pressE50 = (pressEnd1 + pressStart1) / 2
        y_pressE50 = 76 * otn_E50 - otn_E50 * stepE1
    ...
    if press_rzg >= pressEnd1 and pressE50 < pressEnd1:
        press_rzg = (pressEnd1 - pressE50) / 2 + pressE50
...
def start_TPDS_RZG(dct: dict, name: str, methodINTERPOLATION):
    ...
    second_y = [y_repeat_RZG, y_middle_point_second, y_RZG_down]  # от конца первой ветви до середины первлй пелтли
    second_x = [press_repeat_RZG, x_middle_point_second,
                pressRZG_down]  # от конца первой ветви до середины первлй пелтли
