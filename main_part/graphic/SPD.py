...
def SPD_start_new(dct: dict, name: str, organise_dct: dict, methodINTERPOLATION):
    IP = organise_dct.get('IP')
    IL = organise_dct.get('IL')
    e = organise_dct.get('e')
    p = organise_dct.get('p')
    ...
    Eoed01_02_MPa = dct.get('Eoed01_02_MPa')  # Основной одометрический
    Eoed_k_opr = dct.get('Eobs01_02_Mpa')  # Касательный
